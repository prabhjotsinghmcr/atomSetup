...
describe('Complete TCK Test Set', function () {
    ...
    describe('RAML10/Annotations', function () {
        ...
        it("test030", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test030/api.raml");
        });
        it("test031", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test031/api.raml");
        });
        it("test032", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test032/api.raml");
        });
        it("test033", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Annotations/test033/api.raml");
        });
    });
    ...
    describe('RAML10/Examples', function () {
        ...
        it("test052", function () {
            this.timeout(15000);
            tckUtil.testAPI("TCK/RAML10/Examples/test052/api.raml");
        });
    });
